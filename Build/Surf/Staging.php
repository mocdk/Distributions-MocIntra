...
$application->setOption('repositoryUrl', 'git@git.moc.net:Distributions/ZenSystems.git');
...
$application->setDeploymentPath('/dana/data/zen-staging/');
